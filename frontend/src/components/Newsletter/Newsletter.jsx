        ...
        <div className="newsletter" id="newsletter">
            <div className="news-container">
                <div className="left">
                    ...
                    <h2 className="alt2">Get the latest case updates and employment news straight to your inbox.<br />Sign up to our monthly Newsletter <br />by completing your details:</h2>
