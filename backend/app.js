...
const app = express();
const stripe = new Stripe("sk_test_51PqTJAJjhtr0rQfLOW41pikFylpJheI8jknmKEollc5wzTR5Y4ac9ViQtJ45HxG2eOv87W48FleCrrZPMBeK3z5V00tcpPizyB");
...
app.post("/", async (req, res) => {
    ...
    try {
        ...
        const session = await stripe.checkout.sessions.create({
            ...
            line_items: lineItems,
            mode: "payment",
            success_url: "https://myet-project.vercel.app/success",
            cancel_url: "https://myet-project.vercel.app/cancel",
        });
...
//mongodb+srv://sabbirhossainrinku:ASzx1234@cluster0.xbj0t.mongodb.net/?
